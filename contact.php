...
<html dir="ltr" lang="en">
  ...
  <body>
    ...
    <section id="contact_form" class="p-t-60 p-b-50">
      <div class="container">
        <div class="row">
            ...
            <div class="row p-t-40">
              <form id="form">
                ...
                <div class="col-md-12 m-t-20">
                  <div class="single-query">
                    <input
                    style="font-size: 20px !important; height: 45px !important;"
                      type="file"
                      placeholder="Phone Number"
                      class="form-control"
                      name="file"
          ...
          <div class="col-md-4 col-sm-12 colxs-12 m-t-50">
            <div class="form_left">
              <div class="social-icons_1 p-t-10 text-center">
                <h3 class="text-uppercase"><span>3</span>Social Media</h3>
                <ul>
                  <li>
                    <a
                      href="https://www.facebook.com/ALishia-Talent-Management-107450727437819/"
            ...
            <div class="contact-text m-t-20">
              <div class="agent-p-contact">
                <h3 class="color_white">Get In Touch</h3>
                <div class="agetn-contact-2 p-t-35">
                  <p><i class="icon-telephone114"></i>+91 99538 91003</p>
                  <p><i class="icon-icons142"></i>careers@alishia.co.in</p>

                  <p><i class="icon-icons20"></i>Mon to Fri - 08:00 to 7:00 PM</p>
                  <p><i class="icon-icons74"></i>H 101, Imperia Esfera,</p>
                  <p>Sector 37 C, Gurgaon, Haryana india</p>
                </div>
              </div>
            </div>
          </div>
