...
if($_POST){
  ...
  $query = "INSERT Into requirements(position,product,location,industry,des) values('$position','$product','$location','$indusrty','$des')";
        ...
        <div class="row small-spacing">
          <div class="col-xs-12">
            <div class="box-content">
              <form id="forms" onsubmit="return validation()" data-toggle="validator">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <textarea id="desc" class="form-control" name="des" id="" cols="30" rows="10" required></textarea>
                  <div class="help-block with-errors"></div>
                </div>
